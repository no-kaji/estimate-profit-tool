...
- **06_システム管理**: (システム管理者のみ)ユーザーの権限・組織属性(統括部門/拠点/地域区分)の
  割り当て、エラーログ確認
- **07_マイページ**: (マネージャー・ユーザーのみ)個人印鑑の生成、自分が作成した見積もりの履歴
- **08_社判管理**: (マネージャーのみ)社判の登録
- **09_承認**: (マネージャーのみ)確定見積の承認フロー処理(未承認一覧/承認済み一覧)
